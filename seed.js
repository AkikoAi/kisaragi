...
var ksr_jwt_1 = require("@/utils/ksr_jwt");
var db_1 = require("./src/utils/db");
function seed() {
    return __awaiter(this, void 0, void 0, function () {
        var pass, SUPERADMIN, ADMIN, MODERATOR, USER, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
                    console.info("menambahkan seed");
                    return [4 /*yield*/, (0, ksr_jwt_1.hashPassword)(process.env.ADMIN_PASSWORD || "12345678")];
                case 1:
                    pass = _a.sent();
                    return [4 /*yield*/, db_1.default.user.upsert({
                            where: {
                ...
                case 6:
                    e_1 = _a.sent();
                    console.error("Gagal melakukan seeder", e_1);
                    return [3 /*break*/, 7];
