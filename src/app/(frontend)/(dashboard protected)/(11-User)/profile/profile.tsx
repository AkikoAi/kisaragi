...
export default function Profile({ data }: { data: DataAccessLayer }) {
    ...
    return (
        <>
            <h1 className="mt-10 px-4 text-2xl font-bold text-center md:text-left w-full">Profile</h1>
            <section className="mt-2 px-4 flex flex-col md:flex-row gap-6 items-start">
                {/* Sidebar */}
                        ...
                        <li>
                            <button
                                ...
                                className={`cursor-pointer w-full text-left p-2 rounded transition ${tabSelected === "profileSettings"
                                    ? "bg-gray-300 dark:bg-gray-700 border-r-4 border-blue-500"
